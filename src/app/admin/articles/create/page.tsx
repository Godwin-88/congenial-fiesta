        ...
        <div className="flex-1 min-w-0 space-y-4">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <input
              ...
              className="bg-[#1F2937] text-gray-300 px-2 py-1 rounded border
                         border-[#374151] focus:border-[#0066FF] focus:outline-none
          ...
          <textarea
            ...
            maxLength={300}
            rows={2}
            className="w-full bg-[#1F2937] text-gray-300 placeholder-gray-600
                       rounded-lg px-3 py-2 border border-[#374151]
                       focus:border-[#0066FF] focus:outline-none resize-none text-sm"
          />
        ...
        <div className="w-72 shrink-0 space-y-4">
          ...
          <div className="bg-[#1F2937] rounded-lg p-4 space-y-3 border border-[#374151]">
            <button
              ...
              className="w-full py-2 px-4 rounded-lg border border-[#374151]
                         text-gray-300 hover:border-[#0066FF] hover:text-white
            ...
            <button
              ...
              disabled={!canSave || isSaving}
              className="w-full py-2 px-4 rounded-lg bg-[#0066FF] text-white
          ...
          <div className="bg-[#1F2937] rounded-lg border border-[#374151] overflow-hidden">
            <button
              ...
              className="w-full px-4 py-3 text-left text-xs text-gray-400
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#111827] text-white rounded px-3 py-2
                               text-sm border border-[#374151] focus:outline-none
                               focus:border-[#0066FF]"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#111827] text-white rounded px-3 py-2
                               text-sm border border-[#374151] focus:outline-none
                               focus:border-[#0066FF] resize-none"
                  />
                </div>
              </div>
            )}
