    ...
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold text-foreground capitalize">{topSource}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-lg font-bold text-foreground truncate">{topAffiliatePage}</p>
          </CardContent>
        </Card>
      </div>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {searchQueries.map((q, i) => (
                  <tr key={q.query} className="border-b hover:bg-muted/50">
                    <td className="py-2 pr-4 text-muted-foreground">{i + 1}</td>
                ...
                {searchQueries.length === 0 && (
                  <tr><td colSpan={3} className="py-4 text-center text-muted-foreground">No search data</td></tr>
                )}
              </tbody>
            </table>
          </div>
          <p className="text-muted-foreground text-xs mt-2">Source: Upstash Search analytics</p>
        </CardContent>
      </Card>
    </div>
  )
